	...
	if(request.getParameter("btn_login")!=null) //check login button click event not null
	{
		...
		if(rs.next())
		{
			...
			if(email.equals(dbemail) && password.equals(dbpassword))
			{
				...
				response.sendRedirect("details.jsp"); //after login success redirect to welcome.jsp page
			}
		}
		else
		{
        ...
        <form class="form-register" method="post" name="myform" onsubmit="return validate();">
            ...
            <div class="form-register-with-email">
                ...
                <div class="form-white-background">
					...
					<button type="submit" class="btn btn-outline-primary"  name="btn_login">Login</button>
